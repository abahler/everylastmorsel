...
if ($woocommerce_loop['show_products'] && have_posts()) : while (have_posts()) : the_post(); $_product = &new WC_Product( $post->ID ); if (!$_product->is_visible()) continue; $woocommerce_loop['loop']++;
...
if ($woocommerce_loop['show_products']==0) :

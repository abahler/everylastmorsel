...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="variations_form cart" method="post" enctype='multipart/form-data'>
	<table class="variations" cellspacing="0">
		...
		<?php foreach ($attributes as $name => $options) : ?>
			<tr>
				<td><label for="<?php echo sanitize_title($name); ?>"><?php echo __($woocommerce->attribute_label($name), 'woocommerce').": "; ?></label></td>
	...
	<div class="variations_wrap">
		...
		<div class="variations_button">
			...
			<div class="qty"><?php _e('Quantity', 'woocommerce'); ?>:</div>

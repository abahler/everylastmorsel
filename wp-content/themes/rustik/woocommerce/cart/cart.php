	...
	<tbody>
			...
			foreach ($woocommerce->cart->get_cart() as $cart_item_key => $values) :
				...
				if ($_product->exists() && $values['quantity']>0) :
					...
					<tr>
						...
						<td class="product-subtotal"><strong><?php 
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<!-- <a href="<?php //echo esc_url( $woocommerce->cart->get_checkout_url() ); ?>" class="checkout-button button alt"><?php //_e('Proceed to Checkout &rarr;', 'woocommerce'); ?></a> -->

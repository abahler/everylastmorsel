	...
	<table class="shop_table">
		...
		<tfoot>
			...
			<tr class="cart-subtotal">
				<td colspan="2"><strong><?php _e('Cart Subtotal', 'woocommerce'); ?></strong></td>
			...
			<tr class="discount">
				<td colspan="2"><?php _e('Cart Discount', 'woocommerce'); ?></td>
			...
			<tr class="shipping">
				<td colspan="2"><?php _e('Shipping', 'woocommerce'); ?></td>
				<td>
				<?php
					...
					if (sizeof($taxes)>0) :
						...
						if ($has_compound_tax && !$woocommerce->cart->prices_include_tax) :
							...
							<tr class="order-subtotal">
								<td colspan="2"><strong><?php _e('Order Subtotal', 'woocommerce'); ?></strong></td>
						...
						?>
						<tr class="tax">
							<td colspan="2"><?php echo $woocommerce->countries->tax_or_vat(); ?></td>
			...
			<tr class="discount">
				<td colspan="2"><?php _e('Order Discount', 'woocommerce'); ?></td>
			...
			<tr class="total">
				<td colspan="2"><strong><?php _e('Order Total', 'woocommerce'); ?></strong></td>

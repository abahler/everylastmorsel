...
if (!function_exists( 'woo_subscribe_connect')) {
	function woo_subscribe_connect($widget = 'false', $title = '', $form = '', $social = '') {
		...
		$related_posts = '';
		if ( isset( $woo_options[ 'woo_connect_related' ] ) && $woo_options[ 'woo_connect_related' ] == "true" AND $widget != "true" )
			$related_posts = do_shortcode( '[related_posts limit="5"]' );

?>
	<?php if ( isset( $woo_options[ 'woo_connect' ] ) && $woo_options[ 'woo_connect' ] == "true" OR $widget == 'true' ) : ?>
		...
		<div <?php if ( $related_posts != '' ) echo 'class="col-left"'; ?>>
			...
			<?php if ( isset( $woo_options[ 'woo_connect_mailchimp_list_url' ] ) && $woo_options['woo_connect_mailchimp_list_url'] != "" AND $form != 'on' AND $woo_options['woo_connect_newsletter_id'] == "" ) : ?>
			...
			<div class="social<?php if ( $related_posts == '' AND $woo_options[ 'woo_connect_newsletter_id' ] != "" ) echo ' fr'; ?>"><ul>
		   		<?php if ( isset( $woo_options[ 'woo_connect_rss' ] ) && $woo_options[ 'woo_connect_rss' ] == "true" ) { ?>
		...
		<?php if ( isset( $woo_options[ 'woo_connect_related' ] ) && $woo_options[ 'woo_connect_related' ] == "true" AND $related_posts != '' ) : ?>
...
if ( function_exists('register_sidebar') )
    register_sidebar(array(
		...
		'description' => 'Attribute filtering sidebar',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '',
		'after_title' => '',

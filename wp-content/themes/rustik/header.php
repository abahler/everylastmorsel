...
<?php 
if(!is_home()){
	remove_action('wp_head', 'js_NivoSlider');
	remove_action('wp_footer', 'js_NivoSlider');
}
?>
<?php wp_head(); ?>
<?php woo_head(); ?>
...
<div id="wrapper">
	...
	<div id="navigation" class="nav">		
        ...
        <ul id="main-nav" class="nav fl">
			...
			<?php if($_REQUEST['post_type'] || $_REQUEST['product']): ?>
	            	<li class="page_item"><a href="<?php echo home_url( '/' ); ?>"><?php _e( 'Home', 'woothemes' ) ?></a></li>
	        	<?php else: ?>

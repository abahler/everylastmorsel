<?php
	...
	*/
	...
	if (file_exists($nivoslider4wp_files_old)) {
		...
		add_menu_page('Nivo Slider', __('Nivo Slider'), 6, __FILE__, 'nivoslider4wp_panel', get_option('siteurl') . '/wp-content/plugins/nivo-slider-for-wordpress/img/menu.png');
		$plugin_addimages = add_submenu_page(__FILE__ , __('Add/Edit image', 'nivoslider4wp'), __('Add/Edit image', 'nivoslider4wp'), 6, 'nivo-slider-for-wordpress/nivoslider4wp.php');
		$plugin_options = add_submenu_page(__FILE__ , __('Options', 'nivoslider4wp'), __('Options', 'nivoslider4wp'), 6, 'nivoslider4wp-options', 'nivoslider4wp_option');
		...
		add_option('nivoslider4wp_width', 980);
		add_option('nivoslider4wp_height', 460);
		...
		add_option('nivoslider4wp_directionNav', 'false');
		...
		add_option('nivoslider4wp_backgroundCaption', 'ffffff');
		add_option('nivoslider4wp_colorCaption', 'a6a8ac');
		add_option('nivoslider4wp_captionOpacity', '1');
